  ...
  return (
    ...
    >
      ...
      <nav aria-label="Footer navigation" className="flex flex-wrap gap-6 justify-center items-center">
        <Link href="/privacy" className="relative text-zinc-300 hover:text-white transition-colors group focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded">
          {t("nav_privacy")}
          <span className="absolute -bottom-1 left-0 w-0 h-px bg-primary transition-all group-hover:w-full" />
        </Link>
        <Link href="/terms" className="relative text-zinc-300 hover:text-white transition-colors group focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded">
          {t("nav_terms")}
          <span className="absolute -bottom-1 left-0 w-0 h-px bg-primary transition-all group-hover:w-full" />
        </Link>
        <a
          ...
          className="relative text-zinc-300 hover:text-white transition-colors group focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded flex items-center gap-1.5"
        >
