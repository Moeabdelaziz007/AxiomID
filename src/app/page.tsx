      ...
      >
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 px-4 sm:px-6">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[10px] font-mono text-subtle">{language === "en" ? "GitHub" : "GitHub"}</span>
              <span className="text-[10px] font-mono text-subtle">{language === "en" ? "Discord" : "Discord"}</span>
              <span className="text-[10px] font-mono text-subtle">{language === "en" ? "X / Twitter" : "X / Twitter"}</span>
            </div>
          </div>
        </div>
