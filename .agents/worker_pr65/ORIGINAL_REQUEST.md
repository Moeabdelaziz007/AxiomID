## 2026-06-18T20:18:05Z
Identity: You are the Verification Worker for PR 65.
Working directory: /Users/cryptojoker710/Desktop/AxiomID/.agents/worker_pr65/

Task:
1. Stash any local unstaged changes on the active branch to keep the repo clean.
2. Checkout the branch `axiom/doc-review-2259579986238337949` (associated with PR 65). Note that this branch exists remotely as `origin/axiom/doc-review-2259579986238337949`, so you may need to fetch and set up remote tracking.
3. Compare the branch to `main` (using git commands like `git diff main` or `git log main..axiom/doc-review-2259579986238337949` or similar) to identify changed files and analyze design/complexity.
...
6. Post a review comment to GitHub PR 65 using `gh` CLI (e.g. `gh pr review 65 --comment -b "..."`). Make sure the review comment includes:
...
7. Write your detailed review and findings to `/Users/cryptojoker710/Desktop/AxiomID/.agents/worker_pr65/changes.md` and `/Users/cryptojoker710/Desktop/AxiomID/.agents/worker_pr65/handoff.md`.
