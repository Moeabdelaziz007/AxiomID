  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-500 font-mono mt-0.5">Agent ID: {agentId.slice(0, 8)}...</p>
          </div>
        </div>
        <span
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        <div className="rounded-lg p-3 border border-white/5 bg-white/[0.02] text-center">
        ...
        <div className="rounded-lg p-3 border border-white/5 bg-white/[0.02] text-center">
          <span className="text-[9px] font-mono text-gray-500 block">LAST ACTIVE</span>
          <span className="text-[11px] font-mono text-white">
            {lastActive ? new Date(lastActive).toLocaleDateString("en-US", { month: "short", day: "numeric" }) : "Never"}
          </span>
        </div>
      </div>
